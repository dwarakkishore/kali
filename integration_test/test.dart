...
import 'package:kali/flutter_flow/flutter_flow_util.dart';

import 'package:provider/provider.dart';
import 'package:kali/backend/firebase/firebase_config.dart';
...
void main() async {
  ...
  testWidgets('quiz', (WidgetTester tester) async {
    ...
    await FirebaseAuth.instance.signInWithEmailAndPassword(
        email: 'adminy@gmail.com', password: '123456');
